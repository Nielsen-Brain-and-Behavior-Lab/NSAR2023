...
%% Subs with 4 runs
%Load text file
    filename = '/nobackup/scratch/grp/fslg_spec_networks/code/HCP_analysis/Kong2019_parc_fs6_RETEST1/sess_numbers/2_sess.txt';
    delimiter = {''};
...
project_dir = '/fslgroup/grp_hcp/compute/HCP_analysis/parc_output_fs6_HCP_RETEST1/generate_individual_parcellations';
