...
%Read in the subjids text file
    filename = '/nobackup/scratch/grp/fslg_spec_networks/code/HCP_analysis/Kong2019_parc_fs6_RETEST1/subjids/ids.txt';
    delimiter = {''};
...
project_dir = '/fslgroup/grp_hcp/compute/HCP_analysis/parc_output_fs6_HCP_RETEST1/generate_profiles_and_ini_params';
seslist = [1 2];
