...
count=0
sub_count=0
directory = '/fslgroup/fslg_autism_networks/compute/HCP_analysis/CBIG2016_preproc_FS6_ALL/'
for sub in os.scandir(directory): #loop through each subject in the preproc dir
	...
	for network in range(0,18): #Range must be set to actual number of networks +1
		...
		test_dir: str="/fslgroup/grp_hcp/compute/HCP_analysis/parc_output_fs6_HCP_2SESS/generate_individual_parcellations/ind_parcellation/test_set"
		...
		sec_dir: str="/fslgroup/grp_hcp/compute/HCP_analysis/parc_output_fs6_HCP_5MIN/generate_individual_parcellations/ind_parcellation/test_set"
...
#df2=df.pivot(index='SUBJID', columns='Network', values='Dice')

#Save the dataframe as .csv
r_name = "HCP_5MIN_2SESS_dice_LONG_230228.csv" #file name
