...
%Read in the subjids text file
    filename = '/nobackup/scratch/grp/fslg_spec_networks/code/NSD_analysis/Kong2019_parc_all_REST/sess_numbers/6_sess.txt';
    delimiter = {''};
...
project_dir = '/fslgroup/fslg_fun_conn/compute/NSD_analysis/parc_output_fs6_NSD_EVEN_REST/generate_individual_parcellations';
for subid = 1:length(sublist)
        subject=sublist(subid);
       CBIG_MSHBM_generate_individual_parcellation(project_dir,'fsaverage6','6','17',subject,'200','30');
end
