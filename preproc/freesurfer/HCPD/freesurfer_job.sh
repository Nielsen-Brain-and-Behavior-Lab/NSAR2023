...
resultsDir=${genDir}/results/HCPD_analysis/freesurfer

~/compute/research_bin/freesurfer/bin/recon-all \
-subjid sub-${1} \
-i ${dataDir}/sub-${1}/ses-1/anat/sub-${1}_ses-1_T1w.nii.gz \
-wsatlas \
-all \
-sd ${dataDir}/sub-${1}/ses-1/anat
