...
directory = '/fslgroup/fslg_autism_networks/compute/HCP_analysis/CBIG2016_preproc_FS6_ALL/' #set the directory to your preproc output
sub_count = 0
...
r_name = "DVARS_avg_HCP_ALL_230515.csv" #file name
