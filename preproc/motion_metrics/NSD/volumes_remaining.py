...
directory = '/fslgroup/fslg_fun_conn/compute/NSD_analysis/CBIG2016_preproc_FS6_REST_CONSEC/' #set the directory to your preproc output
sub_count = 0
...
r_name = "RemainingVols_NSD_REST_230515.csv" #file name
