...
snr_dir = '/fslgroup/fslg_HBN_preproc/compute/HCPD_analysis/parc_output_fs6_HCPD_REST/quant_metrics/tSNR';
parc_dir = '/fslgroup/fslg_HBN_preproc/compute/HCPD_analysis/parc_output_fs6_HCPD_REST/generate_individual_parcellations/ind_parcellation/test_set';
out_dir= '/fslgroup/fslg_spec_networks/compute/code/HCPD_analysis/tSNR/ALL';

%Load text file
    filename = '/nobackup/scratch/grp/fslg_spec_networks/code/HCPD_analysis/tSNR/ALL/ids.txt';
    delimiter = {''};
...
filename = fullfile(out_dir, 'HCPD_Network_AVG_SNR_230614.csv');
