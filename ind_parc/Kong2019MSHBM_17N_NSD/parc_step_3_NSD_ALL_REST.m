...
%% Subs with 12 runs (All subs have min. of 12. All subs are included in this list).
%Load text file
    filename = '/nobackup/scratch/grp/fslg_spec_networks/code/NSD_analysis/Kong2019_parc_all_REST/sess_numbers/all_12_sess.txt';
    delimiter = {''};
...
project_dir = '/fslgroup/fslg_fun_conn/compute/NSD_analysis/parc_output_fs6_NSD_ALL_REST/generate_individual_parcellations';
for subid = 1:length(sublist)
        subject=sublist(subid);
       CBIG_MSHBM_generate_individual_parcellation(project_dir,'fsaverage6','12','17',subject,'200','30');
end
