...
% Set paths
project_dir = '/fslgroup/fslg_HBN_preproc/compute/HCPD_analysis/parc_output_fs6_HCPD_REST/quant_metrics/network_overlap/ind_parcellation';
...
%HCPD
   filename = '/fslgroup/fslg_spec_networks/compute/code/HCP_analysis/network_overlap_fig/hcpd/study3_HCPD_IDS_230911.txt'; 
   delimiter = {''};
   formatSpec = '%s%[^\n\r]';
